...
99999999999999. If you find inconsistencies in the specs/* then use a  subagent with  to update the specs.
999999999999999. IMPORTANT: Keep @AGENTS.md operational only — status updates and progress notes belong in `IMPLEMENTATION_PLAN.md`. A bloated AGENTS.md pollutes every future loop's context.
9999999999999999. Keep the responses super minimal and cut off the fluff from responses to save tokens.
99999999999999999. Use the fish shell which has access to nimsuggest LSP. ALWAYS use the LSP
